      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        ...
        {showCTA && (
          ...
          >
            <a
              href="/contact"
              className="gold-gradient-bg text-background font-semibold px-8 py-3.5 rounded-lg hover:opacity-90 transition-opacity text-sm"
            >
              Schedule a Consultation
            </a>
            <a
              href="/services"
              className="border border-gold/25 text-gold/70 px-6 py-3 rounded-lg hover:bg-gold/10 hover:text-gold transition-colors text-xs tracking-wide"
            >
